...
player.leaderstats.Rank = rank.Text
   end,
})
local Button = Tab6:CreateButton({
...
if rank and rank:IsA("TextLabel") then
	...
	rank.Text = "Group D | " .. rank.Text
			...
			player.TeamColor = "Electric blue"
   end,
})
local Button = Tab6:CreateButton({
